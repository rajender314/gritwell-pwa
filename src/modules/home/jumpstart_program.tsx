...
import {LayoutWrapper, LeftContainer, ImageContainer, RightContainer, RightContent, BackBtnContainer, BackIconContainer, TextContent, Actions, PlanImageHolder, ProgramCardContent, ProgramCard} from '../sign-up/component/signup.components';
import MainJumstartBG from '@app/assets/images/Main_jumpstart_BG.png';
import ComprehensiveBG from '@app/assets/images/jump_planBG.png.png';
 ...
 */
export default function JumpstartProgram() {
        ...
        <LayoutWrapper className='with-header'>
          <LeftContainer style={{backgroundColor: '#1E3653'}}>
            ...
            <ImageContainer className='d-flex justify-content-center'>
              {/* <div> */}
              <img className='plansImageSyles' alt='inflammationBG' src={MainJumstartBG} />
              {/* </div> */}
            </ImageContainer>
          </LeftContainer>
          <RightContainer>
            <RightContent>
              <div className="content-wrapper">
                ...
                <TextContent className='p-0'>
                  <PlanPageHeader className='mt-0 mb-16'>Jumpstart program</PlanPageHeader>
                  <div className='plansBoldText'>
                  $125 per month for 3 months
                  </div>
                  <InflamtionContent className='mb-32'>You’ll meet monthly and work 1:1 with your functional medicine health coach to receive guidance on medical grade supplements, nutrition and more. </InflamtionContent>
                  <div>
                    <h3 className='plan-h3 m-0'>What’s included</h3>
                    <ul className='jumstart-plan-list'>
                      <li className='plans-li'>1 appointment per month</li>
                ...
                <div style={{background: '#F8F5F0', padding: (isMobile?'40px 24px 16px':'40px 40px 16px'), margin: (isMobile?'0 -24px -24px' : '0 -40px -40px')}}>
                  ...
                  <ProgramCard className='dflex'>
                    <PlanImageHolder><img src={ComprehensiveBG} alt='jumpstartPlan'/> </PlanImageHolder>
                    <ProgramCardContent>
                      <div className='w-100 d-flex justify-content-between'>
                        <ViewProfile>6 MONTHS</ViewProfile>
                        <div className='price'>$199/month</div>
                      </div>
                      <h3 className='planheader' style={{fontSize: '22px', margin: '16px 0', fontWeight: ' 400'}}>Comprehensive program</h3>
                      <Actions className='p-0' style={{flexDirection: 'row'}}>
                        <Button variant={'secondary'}
